...
select concat( a.last_name, ", ", a.first_name, " ", a.middle_name), b.title, b.isbn, p.name from authors a, publishers p, books b, book_authors ba
where
b.book_id = ba.book_id AND  a.author_id = ba.author_id AND p.publisher_id = b.publisher_id
;
...
CREATE TABLE `books`.`publishers` ( `publisher_id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , PRIMARY KEY (`publisher_id`)) ENGINE = InnoDB;


CREATE TABLE `books`.`authors` ( `author_id` INT NOT NULL AUTO_INCREMENT COMMENT 'foreign key to book_authors' , `first_name` VARCHAR(100) NOT NULL DEFAULT '\'\'' , `middle_name` VARCHAR(50) NOT NULL DEFAULT '\'\'' , `last_name` VARCHAR(100) NOT NULL DEFAULT '\'\''  , PRIMARY KEY (`author_id`));

CREATE TABLE `books`.`books` ( `book_id` INT NOT NULL AUTO_INCREMENT , `title` VARCHAR(255) NOT NULL DEFAULT '\'\'' , `total_pages` INT NOT NULL DEFAULT '0' , `rating` DECIMAL(4,2) NOT NULL DEFAULT '0' , `isbn` VARCHAR(13) NOT NULL DEFAULT '\'\'', `published_date` DATE NULL DEFAULT NULL , `publisher_id` INT NOT NULL , PRIMARY KEY (`book_id`)) ENGINE = InnoDB;

CREATE TABLE `books`.`book_authors` ( `book_id` INT NOT NULL , `author_id` INT NOT NULL , PRIMARY KEY (`book_id`, `author_id`)) ENGINE = InnoDB;


CREATE TABLE `books`.`books_detail` ( `book_id` INT NOT NULL , `author_id` INT NOT NULL , `publisher_id` INT NOT NULL , `publisher_name` VARCHAR(255) NOT NULL DEFAULT '\'\'' , `author_name` VARCHAR(255) NOT NULL DEFAULT '\'\'' , `book_title` VARCHAR(255) NOT NULL DEFAULT '\'\'' , `pages` INT NOT NULL DEFAULT '0' , `isbn` VARCHAR(13) NOT NULL DEFAULT '\'\'' , PRIMARY KEY (`book_id`)) ENGINE = InnoDB;
-- publishers
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (75, 'George', NULL, 'P�lya');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (223,'J�r�mie',null,'Zimmermann');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (228,'Erwin',null,'Schr�dinger');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (443, 'Uwe', NULL, 'Schöning');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (492, 'Albert-L�szl�', NULL, 'Barab�si');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (525, 'Viktor', NULL, 'Mayer-Sch�nberger');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (656, 'Tomas', NULL, 'Akenine-M�ller');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (734, 'Miran', NULL, 'Lipovača');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (757, 'Æleen', NULL, 'Frisch');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (771, 'Luís', NULL, 'Rodrigues');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (798, 'Gy�rgy', 'E.', 'R�v�sz');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (862, 'Uwe', NULL, 'Sch�ning');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (895, 'Aur�lien', NULL, 'G�ron');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (1033, 'Éva', NULL, 'Tardos');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (1140, 'Jos�e', NULL, 'Lajoie');
...
INSERT INTO authors (author_id, first_name, middle_name, last_name) VALUES (1161, 'Rapha�l', NULL, 'Hertzog');
...
insert into books (book_id,title,total_pages,rating,isbn,published_date,publisher_id) values (535,'Steal This Computer Book 4.0 Ac€�o What They WonAc€2t Tell You About the Internet 4e',376,3.66,'9781590000000','2006-05-11',139);
...
insert into books (book_id,title,total_pages,rating,isbn,published_date,publisher_id) values (749,'Spam Nation: The Inside Story of Organized Cybercrime Ac€�? from Global Epidemic to Your Front Door',256,3.72,'9781400000000','2014-11-18',196);
...
insert into books (book_id,title,total_pages,rating,isbn,published_date,publisher_id) values (765,'Windows® Internals, Part 2: Covering Windows Server® 2008 R2 and Windows 7',674,4.54,'9780740000000','2012-10-02',128);
...
insert into books (book_id,title,total_pages,rating,isbn,published_date,publisher_id) values (769,'Sams Teach Yourself SQLAc„c in 10 Minutes',242,4.02,'9780670000000','2004-03-01',186);
...
insert into books (book_id,title,total_pages,rating,isbn,published_date,publisher_id) values (802,'WindowsA�® Internals (PRO-Developer)',1232,4.46,'9780740000000','2009-06-17',128);
...
insert into books (book_id,title,total_pages,rating,isbn,published_date,publisher_id) values (869,'Windows® Internals, Part 1: Covering Windows Server® 2008 R2 and Windows 7',754,4.43,'9780740000000','2012-04-05',128);
